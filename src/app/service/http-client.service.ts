...
export class HttpClientService {
  ...
  addToCart(book: Book){
    ...
    return this.httpClient.put<Book>('http://localhost:8080/books/cart/add', book);
  }

  getBookInCartByUser(username){
    return this.httpClient.get<Book>('http://localhost:8080/books/cart/get/' + username);
  }

  removeFromCart(id) {
    return this.httpClient.put<Book>('http://localhost:8080/books/cart/', id);
  }
}
